    ...
    var docfrag = document.createDocumentFragment(),
        ...
        create_bg = function(){
            if(!fs_bg){
                ...
                fs_bg.innerHTML = "";
                fs_bg.id = fs_id + "-bg";
                fs_bg.setAttribute("style", "position: fixed; height: 100%; width: 100%; background: #000; background: rgba(0, 0, 0, 0.45); z-index: 9998; display: block; top: 0; left: 0;");
        ...
        create_fs = function(){
            if(!fs){
                ...
                fs.id = fs_id;
                fs.setAttribute("style", "margin: 0; margin-left: -25%; width: 50%; visibility: visible; display: block; position: absolute; z-index: 9999; top: 88px; left: 50%; opacity: 1; background-color: #FFF; padding: 15px; border: solid 1px #666; box-shadow: 0 0 10px rgba(0, 0, 0, 0.4);");
